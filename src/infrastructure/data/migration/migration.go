...
type MigrateFunc func(*db.Database) error

// RollbackFunc is the func signature for rollbacking.
type RollbackFunc func(*db.Database) error

// InitSchemaFunc is the func signature for initializing the schema.
type InitSchemaFunc func(*db.Database) (string, error)
...
func New(db *db.Database, options *Options, migrations []*Migration) *Migrate {
	return &Migrate{
		db:         db,
		options:    options,
...
func MigrateOrRollback(db *db.Database, init *Migration, migs []*Migration, rollbackVersionID string) {
	//db migration
	mig := New(db, &Options{TableName: "app_versions", IDColumnName: "versionid"}, migs)
