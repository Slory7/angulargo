...
func NewDB(driverName string, dataSourceName string, showSQL bool) (*Database, error) {
	var err error
...
func CacheEntity(entity interface{}, redisConf config.RedisCfg, dbs ...*Database) {
	dbcache := cache.NewDBCacheStore(-1, redisConf)
